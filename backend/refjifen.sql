...
CREATE TABLE `orders` (
  ...
  `points_status` tinyint(1) DEFAULT '0' COMMENT '0=Pending, 1=Settled',
  `settle_date` date DEFAULT NULL COMMENT 'Date to settle points',
  `pending_points` decimal(20,4) DEFAULT '0.0000' COMMENT 'Points pending settlement',
